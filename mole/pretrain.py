...
def main():
    ...
    #dataset = MoleculeDataset("/data/syf/finetune/dataset/" + args.dataset, dataset=args.dataset)
    dataset = PygGraphPropPredDataset(name='ogbg-molpcba', root='/data/syf/finetune/dataset/')
    ...
    tokenizer.from_pretrained(f"./checkpoints/pcba_vqencoder.pth")
    ...
    codebook.from_pretrained(f"./checkpoints/pcba_vqquantizer.pth")
