...
class ExtractSubstructureContextPair:
    ...
    def __call__(self, data, root_idx=None):
        ...
        if len(substruct_node_idxes) > 0:
            ...
            #data.edge_attr_substruct = torch.zeros((substruct_data.edge_index.shape[1],2))
            #print(data)
        ...
        if len(context_node_idxes) > 0:
            ...
            #data.edge_attr_context = torch.zeros((context_data.edge_index.shape[1], 2))
...
class MaskAtom:
    ...
    def __call__(self, data, masked_atom_indices=None):
        ...
        * mask rate number of atom indices
        ...
        for atom_idx in masked_atom_indices:
            data.masked_x[atom_idx][0:2] = torch.tensor([self.num_atom_type, 0])
...
def get_num_task(dataset):
    ...
    if dataset == 'tox21':
        ...
        return 2
    elif dataset == 'Sub_Yelp':
        return 10
    elif dataset == 'Sub_Flickr':
        return 7
